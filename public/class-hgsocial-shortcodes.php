...
class hgSocialShortcodes {
	...
	public function all_buttons( $atts ) {
		...
		if ( $atts['facebook'] || $atts['twitter'] || $atts['google'] || $atts['pinterest'] || $atts['linkedin'] || $atts['stumble'] || $atts['delicious'] || $atts['mail'] ) {
			...
			$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
				...
				$shortcode .= hgSocial::buttons($atts['share_text'], false, $atts['facebook'], $atts['twitter'], $atts['google'], $atts['pinterest'], $atts['linkedin'], $atts['stumble'], $atts['delicious'], $atts['buffer'], $atts['mail'], $atts['url'], $atts['align'], $atts['media'] );
	...
	public function total( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode us_total_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], true, $atts['facebook'], $atts['twitter'], $atts['google'], $atts['pinterest'], $atts['linkedin'], $atts['stumble'], $atts['delicious'], $atts['buffer'], $atts['mail'], $atts['url'], $atts['align'], $atts['media'] );
	...
	public function facebook( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, true, false, false, false, false, false, false, false, false, $atts['url'], $atts['align'], '' );
	...
	public function twitter( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, true, false, false, false, false, false, false, false, $atts['url'], $atts['align'], '' );
	...
	public function google( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, true, false, false, false, false, false, false, $atts['url'], $atts['align'], '' );
	...
	public function pinterest( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, true, false, false, false, false, false, $atts['url'], $atts['align'], $atts['media'] );
	...
	public function linkedin( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, false, true, false, false, false, false, $atts['url'], $atts['align'], '' );
	...
	public function stumble( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, false, false, true, false, false, false, $atts['url'], $atts['align'], '' );
	...
	public function delicious( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, false, false, false, true, false, false, $atts['url'], $atts['align'], '' );
	...
	public function buffer( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, false, false, false, false, true, false, $atts['url'], $atts['align'], '' );
	...
	public function mail( $atts ) {
		...
		$shortcode .= sprintf('<div class="us_shortcode %s">', $atts['custom_class'] );
			...
			$shortcode .= hgSocial::buttons($atts['share_text'], false, false, false, false, false, false, false, false, false, true, $atts['url'], $atts['align'], '' );
